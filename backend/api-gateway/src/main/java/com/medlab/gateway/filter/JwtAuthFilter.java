...
public class JwtAuthFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        // Always pass CORS preflight (OPTIONS) through without JWT validation.
        // The gateway's globalcors config adds the CORS headers; the JWT filter
        // must not block preflight or the browser will never reach the actual call.
