...
import com.medlab.inventory.dto.AddInventoryItemRequest;
...
public class InventoryController {
    ...
    public ResponseEntity<InventoryItemResponse> addItem(
            @Valid @RequestBody AddInventoryItemRequest req) {
        return new ResponseEntity<>(service.addItem(req), HttpStatus.CREATED);
    }
